...
#Beginning on 24 April 2026 for revision
...
setwd("/Users/moncrieff/Library/CloudStorage/Dropbox/Work/Postdoc/Manuscript--Xiphorhynchus/Xipho_revision/PCA")


vcf <- read.vcfR("PopCluster.vcf", verbose = FALSE )
