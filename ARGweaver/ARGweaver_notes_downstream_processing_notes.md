...
----
Basically, had an issue with the formatting of the scaffold/chromosome names in my original ARG files, which got carried down the line. The program bed_to_tre.R cannot handle the variety of scaffold/chromosome names in my files, so I need to update bed_to_tre.R
