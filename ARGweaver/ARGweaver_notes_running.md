...
# Checked missingness across individuals on raw vcf; result was no outliers--all <6% missingness
# Checked mean depth across individuals on raw vcf; no major outliers, lowest was 7.9, highest was 23.2
...
#old command# bedtools slop -b 50 -i xipho_poorGATK.bed -g GATKpoorSites_genomefile.txt > xipho_poorGATK_withSlop.bed
#new command# bedtools slop -b 50 -i xipho_poorGATK.bed -g /ddnA/work/a_monc/postdoc/xipho_project/vcftools_filtering/xipho_genome_file.txt > xipho_poorGATK_withSlop.bed
